...
class _FavoriteState extends State<Favorite> {
  ...
  Future getNewsData() async{
    ...
    var response = await http.get(Uri.https("api.first.org", "data/v1/news"));
            ...
            children:[
              ...
              builder: (context, snapshot){
                if(snapshot.data == null){
                  ...
                  return favouriteNewsList.contains(snapshot.data[i].id) ?
                    Container(
                          ...
                          child: RaisedButton(
                              ...
                              child:Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 7,),
                                  Text("News",style: TextStyle(fontSize: 21))
                                ],
                              ),
                              onPressed: (){
                          ...
                          child: RaisedButton(
                              ...
                              child:Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 7,),
                                  Text("Favs", style: TextStyle(color: Colors.white,fontSize: 21),)
                                ],
                              ),
  ...
  void updateFavList(List favList){
    List<String> encoded_favList=  favouriteNewsList.map((i)=>i.toString()).toList();
